      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            render={<Button variant="ghost" className={styles["sheet-content-absolute"]} size="icon-sm" />}
          >
            <XIcon />
            <span className={styles["sheet-content-sr"]}>Close</span>
          </SheetPrimitive.Close>
        )}
      </SheetPrimitive.Popup>
    </SheetPortal>
